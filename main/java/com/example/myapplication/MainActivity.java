    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        referenceOfStudent.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                ...
                students.add(newPost);
                System.out.println("Previous Post ID: " + prevChildKey);
            }

            @Override
            public void onChildChanged(DataSnapshot dataSnapshot, String prevChildKey) {Student newPost = dataSnapshot.getValue(Student.class);
                students.add(newPost);}

            @Override
            public void onChildRemoved(DataSnapshot dataSnapshot) {Student newPost = dataSnapshot.getValue(Student.class);
                students.add(newPost);}

            @Override
            public void onChildMoved(DataSnapshot dataSnapshot, String prevChildKey) {Student newPost = dataSnapshot.getValue(Student.class);
                students.add(newPost);}
        ...
        referenceOfLandLord.addChildEventListener(new ChildEventListener() {
            @Override
            public void onChildAdded(DataSnapshot dataSnapshot, String prevChildKey) {
                Landlord newPost = dataSnapshot.getValue(Landlord.class);
                landlords.add(newPost);
                System.out.println("Previous Post ID: " + prevChildKey);
            }
