...
public class Address {
    ...
    public Address(String city, String street, String district, String addressExplanation, int houseNo, int floorNo) {
    ...
    public Address(String city, String street, String district, String addressExplanation, int apartmentNo, int houseNo,
            int floorNo) {
        this.houseNo = houseNo;
        this.addressExplanation = addressExplanation;
        this.floorNo = floorNo;
