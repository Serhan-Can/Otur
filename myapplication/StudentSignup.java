...
public class StudentSignup extends AppCompatActivity {
    DatabaseReference referenceOfStudent = FirebaseDatabase.getInstance("https://otur1-be093-default-rtdb.firebaseio.com/").getReference().child("Users").child("Students");
    Intent intent;
    Student student1;
